...
extern PROTOBUF_INTERNAL_EXPORT_Model_5fwindow_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Num_Model_5fwindow_2eproto;
...
static void InitDefaultsscc_info_Num_Model_5fwindow_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::mw::_Num_default_instance_;
    new (ptr) ::mw::Num();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::mw::Num::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Num_Model_5fwindow_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Num_Model_5fwindow_2eproto}, {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_Window_Model_5fwindow_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_Window_Model_5fwindow_2eproto}, {
      ...
      &scc_info_Num_Model_5fwindow_2eproto.base,}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Model_5fwindow_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::mw::Num, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::mw::Num, num_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::mw::Window, nums_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::mw::_Num_default_instance_),
...
const char descriptor_table_protodef_Model_5fwindow_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "s\022\031\n\006models\030\001 \003(\0132\t.mw.Model\"\022\n\003Num\022\013\n\003n"
  "um\030\001 \001(\005\"\206\001\n\006Window\022\026\n\002sm\030\001 \001(\0132\n.mw.Mod"
  "els\022\026\n\002rm\030\002 \001(\0132\n.mw.Models\022\025\n\004nums\030\003 \003("
  "\0132\007.mw.Num\"5\n\006Shapes\022\010\n\004line\020\000\022\010\n\004rect\020\001"
  "\022\n\n\006circle\020\002\022\013\n\007polygon\020\003b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Model_5fwindow_2eproto = {
  &descriptor_table_Model_5fwindow_2eproto_initialized, descriptor_table_protodef_Model_5fwindow_2eproto, "Model_window.proto", 553,
...
Num::Num()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:mw.Num)
}
Num::Num(const Num& from)
  ...
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  num_ = from.num_;
  // @@protoc_insertion_point(copy_constructor:mw.Num)
}
...
Num::~Num() {
  // @@protoc_insertion_point(destructor:mw.Num)
  SharedDtor();
}
...
const Num& Num::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Num_Model_5fwindow_2eproto.base);
  return *internal_default_instance();
}


void Num::Clear() {
// @@protoc_insertion_point(message_clear_start:mw.Num)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* Num::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:mw.Num)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:mw.Num)
  return target;
}

size_t Num::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:mw.Num)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:mw.Num)
  GOOGLE_DCHECK_NE(&from, this);
  const Num* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Num>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mw.Num)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mw.Num)
    MergeFrom(*source);
  }
}

void Num::MergeFrom(const Num& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:mw.Num)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:mw.Num)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:mw.Num)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Window::SharedCtor() {
  ...
  ::memset(&sm_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&rm_) -
      reinterpret_cast<char*>(&sm_)) + sizeof(rm_));
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_nums(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
::PROTOBUF_NAMESPACE_ID::uint8* Window::InternalSerializeWithCachedSizesToArray(
  ...
  // repeated .mw.Num nums = 3;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_nums_size()); i < n; i++) {
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(3, this->_internal_nums(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:mw.Window)
  ...
  // repeated .mw.Num nums = 3;
  total_size += 1UL * this->_internal_nums_size();
  for (const auto& msg : this->nums_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
template<> PROTOBUF_NOINLINE ::mw::Num* Arena::CreateMaybeMessage< ::mw::Num >(Arena* arena) {
  return Arena::CreateInternal< ::mw::Num >(arena);
}
