...
public:
        ...
        : Fl_Menu_Bar(x, y, w, h)
    {
        ...
        Fl_Menu_Item menuitems[] = {
            ...
            {"RED", FL_CTRL + 'r', cb_trans, (void *)FL_RED},
            ...
            {"____", FL_SHIFT + 's', cb_trans, (void *)FL_SOLID},
            {"....", FL_SHIFT + 'd', cb_trans, (void *)FL_DOT},
            {"----", FL_SHIFT + 'a', cb_trans, (void *)FL_DASH},
            {"-.-.", FL_SHIFT + 'b', cb_trans, (void *)FL_DASHDOT},
            {"-..-", FL_SHIFT + 'c', cb_trans, (void *)FL_DASHDOTDOT},
            {0},
            {0},
            {0}
        };
