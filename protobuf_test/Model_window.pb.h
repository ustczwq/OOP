...
extern Stack_intsDefaultTypeInternal _Stack_ints_default_instance_;
class Window;
...
template<> ::mw::Stack_ints* Arena::CreateMaybeMessage<::mw::Stack_ints>(Arena*);
...
class Stack_ints :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mw.Stack_ints) */ {
 public:
  Stack_ints();
  virtual ~Stack_ints();

  Stack_ints(const Stack_ints& from);
  Stack_ints(Stack_ints&& from) noexcept
    : Stack_ints() {
    *this = ::std::move(from);
  }

  inline Stack_ints& operator=(const Stack_ints& from) {
    CopyFrom(from);
    return *this;
  }
  inline Stack_ints& operator=(Stack_ints&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const Stack_ints& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Stack_ints* internal_default_instance() {
    return reinterpret_cast<const Stack_ints*>(
               &_Stack_ints_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(Stack_ints& a, Stack_ints& b) {
    a.Swap(&b);
  }
  inline void Swap(Stack_ints* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline Stack_ints* New() const final {
    return CreateMaybeMessage<Stack_ints>(nullptr);
  }

  Stack_ints* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Stack_ints>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const Stack_ints& from);
  void MergeFrom(const Stack_ints& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Stack_ints* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "mw.Stack_ints";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:mw.Stack_ints)
 private:
  class _Internal;
...
class Window :
 ...
 public:
  ...
  bool has_rm_nums() const;
  private:
  bool _internal_has_rm_nums() const;
  public:
  void clear_rm_nums();
  const ::mw::Stack_ints& rm_nums() const;
  ::mw::Stack_ints* release_rm_nums();
  ::mw::Stack_ints* mutable_rm_nums();
  void set_allocated_rm_nums(::mw::Stack_ints* rm_nums);
  private:
  const ::mw::Stack_ints& _internal_rm_nums() const;
  ::mw::Stack_ints* _internal_mutable_rm_nums();
  public:
...
// repeated int32 ints = 1;
inline int Stack_ints::_internal_ints_size() const {
  return ints_.size();
}
inline int Stack_ints::ints_size() const {
  return _internal_ints_size();
}
inline void Stack_ints::clear_ints() {
  ints_.Clear();
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Stack_ints::_internal_ints(int index) const {
  return ints_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Stack_ints::ints(int index) const {
  // @@protoc_insertion_point(field_get:mw.Stack_ints.ints)
  return _internal_ints(index);
}
inline void Stack_ints::set_ints(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ints_.Set(index, value);
  // @@protoc_insertion_point(field_set:mw.Stack_ints.ints)
}
inline void Stack_ints::_internal_add_ints(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ints_.Add(value);
}
inline void Stack_ints::add_ints(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_add_ints(value);
  // @@protoc_insertion_point(field_add:mw.Stack_ints.ints)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
Stack_ints::_internal_ints() const {
  return ints_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
Stack_ints::ints() const {
  // @@protoc_insertion_point(field_list:mw.Stack_ints.ints)
  return _internal_ints();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >*
Stack_ints::_internal_mutable_ints() {
  return &ints_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >*
Stack_ints::mutable_ints() {
  // @@protoc_insertion_point(field_mutable_list:mw.Stack_ints.ints)
...
// .mw.Stack_ints rm_nums = 3;
inline bool Window::_internal_has_rm_nums() const {
  return this != internal_default_instance() && rm_nums_ != nullptr;
}
inline bool Window::has_rm_nums() const {
  return _internal_has_rm_nums();
}
inline void Window::clear_rm_nums() {
  if (GetArenaNoVirtual() == nullptr && rm_nums_ != nullptr) {
    delete rm_nums_;
  }
  rm_nums_ = nullptr;
}
inline const ::mw::Stack_ints& Window::_internal_rm_nums() const {
  const ::mw::Stack_ints* p = rm_nums_;
  return p != nullptr ? *p : *reinterpret_cast<const ::mw::Stack_ints*>(
      &::mw::_Stack_ints_default_instance_);
}
inline const ::mw::Stack_ints& Window::rm_nums() const {
  // @@protoc_insertion_point(field_get:mw.Window.rm_nums)
  return _internal_rm_nums();
}
inline ::mw::Stack_ints* Window::release_rm_nums() {
  // @@protoc_insertion_point(field_release:mw.Window.rm_nums)
  
  ::mw::Stack_ints* temp = rm_nums_;
  rm_nums_ = nullptr;
  return temp;
}
inline ::mw::Stack_ints* Window::_internal_mutable_rm_nums() {
  
  if (rm_nums_ == nullptr) {
    auto* p = CreateMaybeMessage<::mw::Stack_ints>(GetArenaNoVirtual());
    rm_nums_ = p;
  }
  return rm_nums_;
}
inline ::mw::Stack_ints* Window::mutable_rm_nums() {
  // @@protoc_insertion_point(field_mutable:mw.Window.rm_nums)
  return _internal_mutable_rm_nums();
}
inline void Window::set_allocated_rm_nums(::mw::Stack_ints* rm_nums) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete rm_nums_;
  }
  if (rm_nums) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      rm_nums = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, rm_nums, submessage_arena);
    }
  ...
  rm_nums_ = rm_nums;
  // @@protoc_insertion_point(field_set_allocated:mw.Window.rm_nums)
}
